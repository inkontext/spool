const SM_PACK_INIT = 'init-pack';
const SM_PACK_UPDATE = 'update-pack';
const SM_PACK_REMOVE = 'remove-pack';

const OS_GET_OBJ = 'get-obj';
const OS_SEND_OBJ = 'send-obj';

const ASIGN_CLIENT_ID = 'asign-id';

const SM_KEY_PRESS = 'key-press';
const SM_MOUSE_CLICKED = 'mouse-clicked';

const KI_MOV_LEFT = 'MOV_LEFT';
const KI_MOV_RIGHT = 'MOV_RIGHT';
const KI_MOV_UP = 'KI_MOV_UP';
const KI_MOV_DOWN = 'KI_MOV_DOWN';
